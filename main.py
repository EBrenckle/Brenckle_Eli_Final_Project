# Created by Eli Brenckle
# Sources

# Idea: Metroidvania using Unity
# Goals: Basic animations (stick figures), use of movement powerups, two or more bosses, handful of different enemies. 
